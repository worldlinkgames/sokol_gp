...
static void frame(void) {
    ...
    sgp_set_image(IMG_effect_iTexChannel0, image);
    sgp_set_image(IMG_effect_iTexChannel1, perlin_image);
    ...
    sgp_reset_image(IMG_effect_iTexChannel0);
    sgp_reset_image(IMG_effect_iTexChannel1);
